...
export const HistoricalInfo = {
  ...
  fromJSON(object: any): HistoricalInfo {
    return {
      ...
      valset: gt.Array.isArray(object?.valset) ? object.valset.map((e: any) => Validator.fromJSON(e)) : [],
    };
  },
...
export const Validator = {
  ...
  fromJSON(object: any): Validator {
    return {
      ...
      unbondingHeight: isSet(object.unbondingHeight) ? gt.Number(object.unbondingHeight) : 0,
...
export const ValAddresses = {
  ...
  fromJSON(object: any): ValAddresses {
    return { addresses: gt.Array.isArray(object?.addresses) ? object.addresses.map((e: any) => gt.String(e)) : [] };
  },
...
export const DVPairs = {
  ...
  fromJSON(object: any): DVPairs {
    return { pairs: gt.Array.isArray(object?.pairs) ? object.pairs.map((e: any) => DVPair.fromJSON(e)) : [] };
  },
...
export const DVVTriplets = {
  ...
  fromJSON(object: any): DVVTriplets {
    return {
      triplets: gt.Array.isArray(object?.triplets) ? object.triplets.map((e: any) => DVVTriplet.fromJSON(e)) : [],
    };
  },
...
export const Redelegation = {
  ...
  fromJSON(object: any): Redelegation {
    return {
      ...
      validatorSrcAddress: isSet(object.validatorSrcAddress) ? gt.String(object.validatorSrcAddress) : "",
      validatorDstAddress: isSet(object.validatorDstAddress) ? gt.String(object.validatorDstAddress) : "",
      entries: gt.Array.isArray(object?.entries) ? object.entries.map((e: any) => RedelegationEntry.fromJSON(e)) : [],
    };
  },
