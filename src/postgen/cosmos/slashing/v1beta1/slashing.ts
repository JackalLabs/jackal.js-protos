...
export const ValidatorSigningInfo = {
  ...
  fromJSON(object: any): ValidatorSigningInfo {
    return {
      ...
      startHeight: isSet(object.startHeight) ? gt.Number(object.startHeight) : 0,
      indexOffset: isSet(object.indexOffset) ? gt.Number(object.indexOffset) : 0,
      ...
      missedBlocksCounter: isSet(object.missedBlocksCounter) ? gt.Number(object.missedBlocksCounter) : 0,
    };
  },
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    return {
      signedBlocksWindow: isSet(object.signedBlocksWindow) ? gt.Number(object.signedBlocksWindow) : 0,
