...
export const App = {
  ...
  fromJSON(object: any): App {
    return {
      protocol: isSet(object.protocol) ? gt.Number(object.protocol) : 0,
...
export const Consensus = {
  ...
  fromJSON(object: any): Consensus {
    return {
      block: isSet(object.block) ? gt.Number(object.block) : 0,
      app: isSet(object.app) ? gt.Number(object.app) : 0,
    };
  },
