...
export const Data = {
  ...
  fromJSON(object: any): Data {
    return { txs: gt.Array.isArray(object?.txs) ? object.txs.map((e: any) => bytesFromBase64(e)) : [] };
  },
...
export const Commit = {
  ...
  fromJSON(object: any): Commit {
    return {
      ...
      round: isSet(object.round) ? gt.Number(object.round) : 0,
      blockId: isSet(object.blockId) ? BlockID.fromJSON(object.blockId) : undefined,
      signatures: gt.Array.isArray(object?.signatures) ? object.signatures.map((e: any) => CommitSig.fromJSON(e)) : [],
    };
  },
...
export const BlockMeta = {
  ...
  fromJSON(object: any): BlockMeta {
    return {
      blockId: isSet(object.blockId) ? BlockID.fromJSON(object.blockId) : undefined,
      blockSize: isSet(object.blockSize) ? gt.Number(object.blockSize) : 0,
      header: isSet(object.header) ? Header.fromJSON(object.header) : undefined,
      numTxs: isSet(object.numTxs) ? gt.Number(object.numTxs) : 0,
    };
  },
