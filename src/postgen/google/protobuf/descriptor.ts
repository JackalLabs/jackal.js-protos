...
export const FileDescriptorSet = {
  ...
  fromJSON(object: any): FileDescriptorSet {
    return { file: gt.Array.isArray(object?.file) ? object.file.map((e: any) => FileDescriptorProto.fromJSON(e)) : [] };
  },
...
export const DescriptorProto = {
  ...
  fromJSON(object: any): DescriptorProto {
    return {
      name: isSet(object.name) ? gt.String(object.name) : "",
      field: gt.Array.isArray(object?.field) ? object.field.map((e: any) => FieldDescriptorProto.fromJSON(e)) : [],
      extension: gt.Array.isArray(object?.extension)
        ? object.extension.map((e: any) => FieldDescriptorProto.fromJSON(e))
        : [],
...
export const EnumDescriptorProto = {
  ...
  fromJSON(object: any): EnumDescriptorProto {
    return {
      name: isSet(object.name) ? gt.String(object.name) : "",
      value: gt.Array.isArray(object?.value) ? object.value.map((e: any) => EnumValueDescriptorProto.fromJSON(e)) : [],
      ...
      reservedRange: gt.Array.isArray(object?.reservedRange)
        ...
        : [],
      reservedName: gt.Array.isArray(object?.reservedName) ? object.reservedName.map((e: any) => gt.String(e)) : [],
    };
  },
...
export const ServiceDescriptorProto = {
  ...
  fromJSON(object: any): ServiceDescriptorProto {
    return {
      name: isSet(object.name) ? gt.String(object.name) : "",
      method: gt.Array.isArray(object?.method) ? object.method.map((e: any) => MethodDescriptorProto.fromJSON(e)) : [],
...
export const FileOptions = {
  ...
  fromJSON(object: any): FileOptions {
    return {
      ...
      ccEnableArenas: isSet(object.ccEnableArenas) ? gt.Boolean(object.ccEnableArenas) : false,
...
export const UninterpretedOption = {
  ...
  fromJSON(object: any): UninterpretedOption {
    return {
      name: gt.Array.isArray(object?.name) ? object.name.map((e: any) => UninterpretedOption_NamePart.fromJSON(e)) : [],
      identifierValue: isSet(object.identifierValue) ? gt.String(object.identifierValue) : "",
      positiveIntValue: isSet(object.positiveIntValue) ? gt.Number(object.positiveIntValue) : 0,
      negativeIntValue: isSet(object.negativeIntValue) ? gt.Number(object.negativeIntValue) : 0,
