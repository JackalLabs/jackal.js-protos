...
export const Height = {
  ...
  fromJSON(object: any): Height {
    return {
      revisionNumber: isSet(object.revisionNumber) ? gt.Number(object.revisionNumber) : 0,
      revisionHeight: isSet(object.revisionHeight) ? gt.Number(object.revisionHeight) : 0,
    };
  },
  ...
  fromJSON(object: any): Params {
    return {
      allowedClients: gt.Array.isArray(object?.allowedClients)
        ? object.allowedClients.map((e: any) => gt.String(e))
        : [],
    };
  },
