...
export const Supply = {
  ...
  fromJSON(object: any): Supply {
    return { total: gt.Array.isArray(object?.total) ? object.total.map((e: any) => Coin.fromJSON(e)) : [] };
  },
...
export const DenomUnit = {
  ...
  fromJSON(object: any): DenomUnit {
    return {
      ...
      aliases: gt.Array.isArray(object?.aliases) ? object.aliases.map((e: any) => gt.String(e)) : [],
    };
  },
...
export const Metadata = {
  ...
  fromJSON(object: any): Metadata {
    return {
      ...
      denomUnits: gt.Array.isArray(object?.denomUnits) ? object.denomUnits.map((e: any) => DenomUnit.fromJSON(e)) : [],
