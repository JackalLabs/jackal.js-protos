...
export const MsgMultiSend = {
  ...
  fromJSON(object: any): MsgMultiSend {
    return {
      inputs: gt.Array.isArray(object?.inputs) ? object.inputs.map((e: any) => Input.fromJSON(e)) : [],
      outputs: gt.Array.isArray(object?.outputs) ? object.outputs.map((e: any) => Output.fromJSON(e)) : [],
    };
  },
