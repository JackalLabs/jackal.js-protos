...
export const Proposal = {
  ...
  fromJSON(object: any): Proposal {
    return {
      ...
      totalDeposit: gt.Array.isArray(object?.totalDeposit) ? object.totalDeposit.map((e: any) => Coin.fromJSON(e)) : [],
...
export const Vote = {
  ...
  fromJSON(object: any): Vote {
    return {
      ...
      option: isSet(object.option) ? voteOptionFromJSON(object.option) : 0,
      options: gt.Array.isArray(object?.options) ? object.options.map((e: any) => WeightedVoteOption.fromJSON(e)) : [],
    };
  },
...
export const DepositParams = {
  ...
  fromJSON(object: any): DepositParams {
    return {
      minDeposit: gt.Array.isArray(object?.minDeposit) ? object.minDeposit.map((e: any) => Coin.fromJSON(e)) : [],
