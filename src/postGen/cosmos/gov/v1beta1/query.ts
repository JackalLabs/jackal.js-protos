...
export const QueryProposalRequest = {
  ...
  fromJSON(object: any): QueryProposalRequest {
    return { proposalId: isSet(object.proposalId) ? gt.Number(object.proposalId) : 0 };
  },
...
export const QueryProposalsResponse = {
  ...
  fromJSON(object: any): QueryProposalsResponse {
    return {
      proposals: gt.Array.isArray(object?.proposals) ? object.proposals.map((e: any) => Proposal.fromJSON(e)) : [],
...
export const QueryVoteRequest = {
  ...
  fromJSON(object: any): QueryVoteRequest {
    return {
      proposalId: isSet(object.proposalId) ? gt.Number(object.proposalId) : 0,
      voter: isSet(object.voter) ? gt.String(object.voter) : "",
    };
  },
...
export const QueryVotesResponse = {
  ...
  fromJSON(object: any): QueryVotesResponse {
    return {
      votes: gt.Array.isArray(object?.votes) ? object.votes.map((e: any) => Vote.fromJSON(e)) : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined,
    };
  },
...
export const QueryDepositsResponse = {
  ...
  fromJSON(object: any): QueryDepositsResponse {
    return {
      deposits: gt.Array.isArray(object?.deposits) ? object.deposits.map((e: any) => Deposit.fromJSON(e)) : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined,
    };
  },
