...
export const QueryValidatorSlashesRequest = {
  ...
  fromJSON(object: any): QueryValidatorSlashesRequest {
    return {
      ...
      startingHeight: isSet(object.startingHeight) ? gt.Number(object.startingHeight) : 0,
      endingHeight: isSet(object.endingHeight) ? gt.Number(object.endingHeight) : 0,
...
export const QueryValidatorSlashesResponse = {
  ...
  fromJSON(object: any): QueryValidatorSlashesResponse {
    return {
      slashes: gt.Array.isArray(object?.slashes) ? object.slashes.map((e: any) => ValidatorSlashEvent.fromJSON(e)) : [],
...
export const QueryDelegationRewardsResponse = {
  ...
  fromJSON(object: any): QueryDelegationRewardsResponse {
    return { rewards: gt.Array.isArray(object?.rewards) ? object.rewards.map((e: any) => DecCoin.fromJSON(e)) : [] };
  },
  ...
  fromJSON(object: any): QueryDelegationTotalRewardsResponse {
    return {
      rewards: gt.Array.isArray(object?.rewards)
        ...
        : [],
      total: gt.Array.isArray(object?.total) ? object.total.map((e: any) => DecCoin.fromJSON(e)) : [],
    };
  },
...
export const QueryDelegatorValidatorsResponse = {
  ...
  fromJSON(object: any): QueryDelegatorValidatorsResponse {
    return { validators: gt.Array.isArray(object?.validators) ? object.validators.map((e: any) => gt.String(e)) : [] };
  },
...
export const QueryCommunityPoolResponse = {
  ...
  fromJSON(object: any): QueryCommunityPoolResponse {
    return { pool: gt.Array.isArray(object?.pool) ? object.pool.map((e: any) => DecCoin.fromJSON(e)) : [] };
  },
