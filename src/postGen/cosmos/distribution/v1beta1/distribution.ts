...
export const ValidatorCurrentRewards = {
  ...
  fromJSON(object: any): ValidatorCurrentRewards {
    return {
      rewards: gt.Array.isArray(object?.rewards) ? object.rewards.map((e: any) => DecCoin.fromJSON(e)) : [],
...
export const ValidatorAccumulatedCommission = {
  ...
  fromJSON(object: any): ValidatorAccumulatedCommission {
    return {
      commission: gt.Array.isArray(object?.commission) ? object.commission.map((e: any) => DecCoin.fromJSON(e)) : [],
    };
  },
...
export const ValidatorSlashEvent = {
  ...
  fromJSON(object: any): ValidatorSlashEvent {
    return {
      validatorPeriod: isSet(object.validatorPeriod) ? gt.Number(object.validatorPeriod) : 0,
...
export const DelegationDelegatorReward = {
  ...
  fromJSON(object: any): DelegationDelegatorReward {
    return {
      ...
      reward: gt.Array.isArray(object?.reward) ? object.reward.map((e: any) => DecCoin.fromJSON(e)) : [],
    };
  },
