...
export const RequestInfo = {
  ...
  fromJSON(object: any): RequestInfo {
    return {
      ...
      blockVersion: isSet(object.blockVersion) ? gt.Number(object.blockVersion) : 0,
      p2pVersion: isSet(object.p2pVersion) ? gt.Number(object.p2pVersion) : 0,
    };
  },
...
export const RequestInitChain = {
  ...
  fromJSON(object: any): RequestInitChain {
    return {
      ...
      initialHeight: isSet(object.initialHeight) ? gt.Number(object.initialHeight) : 0,
    };
  },
...
export const RequestEndBlock = {
  ...
  fromJSON(object: any): RequestEndBlock {
    return { height: isSet(object.height) ? gt.Number(object.height) : 0 };
  },
...
export const ResponseInfo = {
  ...
  fromJSON(object: any): ResponseInfo {
    return {
      ...
      version: isSet(object.version) ? gt.String(object.version) : "",
      appVersion: isSet(object.appVersion) ? gt.Number(object.appVersion) : 0,
      lastBlockHeight: isSet(object.lastBlockHeight) ? gt.Number(object.lastBlockHeight) : 0,
...
export const ResponseBeginBlock = {
  ...
  fromJSON(object: any): ResponseBeginBlock {
    return { events: gt.Array.isArray(object?.events) ? object.events.map((e: any) => Event.fromJSON(e)) : [] };
  },
...
export const ResponseCheckTx = {
  ...
  fromJSON(object: any): ResponseCheckTx {
    return {
      ...
      log: isSet(object.log) ? gt.String(object.log) : "",
      info: isSet(object.info) ? gt.String(object.info) : "",
      gasWanted: isSet(object.gas_wanted) ? gt.Number(object.gas_wanted) : 0,
      gasUsed: isSet(object.gas_used) ? gt.Number(object.gas_used) : 0,
      ...
      mempoolError: isSet(object.mempoolError) ? gt.String(object.mempoolError) : "",
    };
  },
...
export const ResponseCommit = {
  ...
  fromJSON(object: any): ResponseCommit {
    return {
      data: isSet(object.data) ? bytesFromBase64(object.data) : new Uint8Array(0),
      retainHeight: isSet(object.retainHeight) ? gt.Number(object.retainHeight) : 0,
    };
  },
...
export const ResponseListSnapshots = {
  ...
  fromJSON(object: any): ResponseListSnapshots {
    return {
      snapshots: gt.Array.isArray(object?.snapshots) ? object.snapshots.map((e: any) => Snapshot.fromJSON(e)) : [],
    };
  },
...
export const ResponseApplySnapshotChunk = {
  ...
  fromJSON(object: any): ResponseApplySnapshotChunk {
    return {
      ...
      refetchChunks: gt.Array.isArray(object?.refetchChunks) ? object.refetchChunks.map((e: any) => gt.Number(e)) : [],
      rejectSenders: gt.Array.isArray(object?.rejectSenders) ? object.rejectSenders.map((e: any) => gt.String(e)) : [],
    };
  },
...
export const Validator = {
  ...
  fromJSON(object: any): Validator {
    return {
      ...
      power: isSet(object.power) ? gt.Number(object.power) : 0,
    };
  },
...
export const VoteInfo = {
  ...
  fromJSON(object: any): VoteInfo {
    return {
      ...
      signedLastBlock: isSet(object.signedLastBlock) ? gt.Boolean(object.signedLastBlock) : false,
    };
  },
...
export const Evidence = {
  ...
  fromJSON(object: any): Evidence {
    return {
      ...
      height: isSet(object.height) ? gt.Number(object.height) : 0,
      time: isSet(object.time) ? fromJsonTimestamp(object.time) : undefined,
      totalVotingPower: isSet(object.totalVotingPower) ? gt.Number(object.totalVotingPower) : 0,
    };
  },
