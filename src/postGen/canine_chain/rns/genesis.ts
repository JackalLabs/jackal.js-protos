...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      whoIsList: gt.Array.isArray(object?.whoIsList) ? object.whoIsList.map((e: any) => Whois.fromJSON(e)) : [],
      namesList: gt.Array.isArray(object?.namesList) ? object.namesList.map((e: any) => Names.fromJSON(e)) : [],
      bidsList: gt.Array.isArray(object?.bidsList) ? object.bidsList.map((e: any) => Bids.fromJSON(e)) : [],
      forSaleList: gt.Array.isArray(object?.forSaleList) ? object.forSaleList.map((e: any) => Forsale.fromJSON(e)) : [],
      initList: gt.Array.isArray(object?.initList) ? object.initList.map((e: any) => Init.fromJSON(e)) : [],
    };
  },
