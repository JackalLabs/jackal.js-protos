...
export const StoreCodeAuthorization = {
  ...
  fromJSON(object: any): StoreCodeAuthorization {
    return { grants: gt.Array.isArray(object?.grants) ? object.grants.map((e: any) => CodeGrant.fromJSON(e)) : [] };
  },
...
export const ContractExecutionAuthorization = {
  ...
  fromJSON(object: any): ContractExecutionAuthorization {
    return { grants: gt.Array.isArray(object?.grants) ? object.grants.map((e: any) => ContractGrant.fromJSON(e)) : [] };
  },
...
export const MaxCallsLimit = {
  ...
  fromJSON(object: any): MaxCallsLimit {
    return { remaining: isSet(object.remaining) ? gt.Number(object.remaining) : 0 };
  },
...
export const MaxFundsLimit = {
  ...
  fromJSON(object: any): MaxFundsLimit {
    return { amounts: gt.Array.isArray(object?.amounts) ? object.amounts.map((e: any) => Coin.fromJSON(e)) : [] };
  },
...
export const CombinedLimit = {
  ...
  fromJSON(object: any): CombinedLimit {
    return {
      callsRemaining: isSet(object.callsRemaining) ? gt.Number(object.callsRemaining) : 0,
      amounts: gt.Array.isArray(object?.amounts) ? object.amounts.map((e: any) => Coin.fromJSON(e)) : [],
    };
  },
...
export const AcceptedMessageKeysFilter = {
  ...
  fromJSON(object: any): AcceptedMessageKeysFilter {
    return { keys: gt.Array.isArray(object?.keys) ? object.keys.map((e: any) => gt.String(e)) : [] };
  },
...
export const AcceptedMessagesFilter = {
  ...
  fromJSON(object: any): AcceptedMessagesFilter {
    return { messages: gt.Array.isArray(object?.messages) ? object.messages.map((e: any) => bytesFromBase64(e)) : [] };
  },
