...
export default interface IQueryStaking {
  ...
  queryValidators (request: DeepPartial<QueryValidatorsRequest>, metadata?: grpc.Metadata): Promise<SuccessNoUndefined<QueryValidatorsResponse>>;

  /** Validator queries validator info for given validator address. */
  queryValidator (request: DeepPartial<QueryValidatorRequest>, metadata?: grpc.Metadata): Promise<SuccessNoUndefined<QueryValidatorResponse>>;
  ...
  queryDelegation (request: DeepPartial<QueryDelegationRequest>, metadata?: grpc.Metadata): Promise<SuccessNoUndefined<QueryDelegationResponse>>;
  ...
  queryPool (request: DeepPartial<QueryPoolRequest>, metadata?: grpc.Metadata): Promise<SuccessNoUndefined<QueryPoolResponse>>;
