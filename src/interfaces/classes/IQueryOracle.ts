...
export default interface IQueryOracle {
  ...
  queryFeed (request: DeepPartial<QueryFeedRequest>, metadata?: grpc.Metadata): Promise<SuccessNoUndefined<QueryFeedResponse>>;

  queryAllFeeds (request: DeepPartial<QueryAllFeedsRequest>, metadata?: grpc.Metadata): Promise<SuccessNoUndefined<QueryAllFeedsResponse>>;
}
