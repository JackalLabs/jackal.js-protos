...
export class TxOracle implements ITxOracle {
  msgCreateFeed (data: MsgCreateFeed): EncodeObject {
    return { typeUrl: oracleTypes.createFeed[0], value: oracleTypes.createFeed[1].fromPartial( data ) }
  }
  msgUpdateFeed (data: MsgUpdateFeed): EncodeObject {
    return { typeUrl: oracleTypes.updateFeed[0], value: oracleTypes.updateFeed[1].fromPartial( data ) }
  }
}
