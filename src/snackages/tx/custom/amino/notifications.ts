...
export function createNotificationsAminoConverters (): AminoConverters {
  return {
    "/canine_chain.notifications.MsgCreateNotifications": {
      ...
      toAmino: (value: MsgCreateNotifications): AminoMsgCreateNotifications["value"] => ({
        creator: value.creator,
        notification: value.notification,
        address: value.address
      }),
      fromAmino: (value: AminoMsgCreateNotifications["value"]): MsgCreateNotifications => ({
        creator: value.creator,
        notification: value.notification,
        address: value.address
      })
    ...
    "/canine_chain.notifications.MsgUpdateNotifications": {
      ...
      toAmino: (value: MsgUpdateNotifications): AminoMsgUpdateNotifications["value"] => ({
        creator: value.creator,
        count: value.count,
        notification: value.notification,
        address: value.address
      }),
      fromAmino: (value: AminoMsgUpdateNotifications["value"]): MsgUpdateNotifications => ({
        creator: value.creator,
        count: value.count,
        notification: value.notification,
        address: value.address
    ...
    "/canine_chain.notifications.MsgDeleteNotifications": {
      ...
      toAmino: (value: MsgDeleteNotifications): AminoMsgDeleteNotifications["value"] => ({
        creator: value.creator
      }),
      fromAmino: (value: AminoMsgDeleteNotifications["value"]): MsgDeleteNotifications => ({
        creator: value.creator
      })
    },
