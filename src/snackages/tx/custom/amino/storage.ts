...
export function createStorageAminoConverters (): AminoConverters {
  return {
    ...
    "/canine_chain.storage.MsgSetProviderKeybase": {
      ...
      toAmino: (value: MsgSetProviderKeybase): AminoMsgSetProviderKeybase["value"] => ({
        creator: value.creator,
        keybase: value.keybase
      }),
      fromAmino: (value: AminoMsgSetProviderKeybase["value"]): MsgSetProviderKeybase => ({
        creator: value.creator,
        keybase: value.keybase
      })
    },
    "/canine_chain.storage.MsgSetProviderTotalspace": {
      ...
      toAmino: (value: MsgSetProviderTotalspace): AminoMsgSetProviderTotalspace["value"] => ({
        creator: value.creator,
        space: value.space
      }),
      fromAmino: (value: AminoMsgSetProviderTotalspace["value"]): MsgSetProviderTotalspace => ({
        creator: value.creator,
        space: value.space
      })
    },
    ...
    "/canine_chain.storage.MsgCancelContract": {
      ...
      fromAmino: (value: AminoMsgCancelContract["value"]): MsgCancelContract => ({
        creator: value.creator,
        cid: value.cid
      })
    },
    ...
    "/canine_chain.storage.MsgUpgradeStorage": {
      ...
      fromAmino: (value: AminoMsgUpgradeStorage["value"]): MsgUpgradeStorage => ({
        creator: value.creator,
        forAddress: value.for_address,
        duration: value.duration,
        bytes: value.bytes,
