...
export class TxStaking implements ITxStaking {
  msgBeginRedelegate (data: MsgBeginRedelegate): EncodeObject {
    return { typeUrl: stakingTypes.beginRedelegate[0], value: stakingTypes.beginRedelegate[1].fromPartial( data ) }
  }
  msgCreateValidator (data: MsgCreateValidator): EncodeObject {
    return { typeUrl: stakingTypes.msgCreateValidator[0], value: stakingTypes.msgCreateValidator[1].fromPartial( data ) }
  }
  msgDelegate (data: MsgDelegate): EncodeObject {
    return { typeUrl: stakingTypes.delegate[0], value: stakingTypes.delegate[1].fromPartial( data ) }
  }
  msgEditValidator (data: MsgEditValidator): EncodeObject {
    return { typeUrl: stakingTypes.editValidator[0], value: stakingTypes.editValidator[1].fromPartial( data ) }
  }
  msgUndelegate (data: MsgUndelegate): EncodeObject {
    return { typeUrl: stakingTypes.undelegate[0], value: stakingTypes.undelegate[1].fromPartial( data ) }
  }
}
