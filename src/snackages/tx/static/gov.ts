...
export class TxGov implements ITxGov {
  msgDeposit (data: MsgDeposit): EncodeObject {
    return { typeUrl: govTypes.deposit[0], value: govTypes.deposit[1].fromPartial( data ) }
  }
  msgSubmitProposal (data: MsgSubmitProposal): EncodeObject {
    return { typeUrl: govTypes.submitProposal[0], value: govTypes.submitProposal[1].fromPartial( data ) }
  }
  msgVote (data: MsgVote): EncodeObject {
    return { typeUrl: govTypes.vote[0], value: govTypes.vote[1].fromPartial( data ) }
  }
  msgVoteWeighted (data: MsgVoteWeighted): EncodeObject {
    return { typeUrl: govTypes.voteWeighted[0], value: govTypes.voteWeighted[1].fromPartial( data ) }
  }
}
