...
export class TxDistribution implements ITxDistribution {
  msgFundCommunityPool (data: MsgFundCommunityPool): EncodeObject {
    return { typeUrl: distibutionTypes.fundCommunityPool[0], value: distibutionTypes.fundCommunityPool[1].fromPartial( data ) }
  }
  msgSetWithdrawAddress (data: MsgSetWithdrawAddress): EncodeObject {
    return { typeUrl: distibutionTypes.setWithdrawAddress[0], value: distibutionTypes.setWithdrawAddress[1].fromPartial( data ) }
  }
  msgWithdrawDelegatorReward (data: MsgWithdrawDelegatorReward): EncodeObject {
    return { typeUrl: distibutionTypes.withdrawDelegatorReward[0], value: distibutionTypes.withdrawDelegatorReward[1].fromPartial( data ) }
  }
  msgWithdrawValidatorCommission (data: MsgWithdrawValidatorCommission): EncodeObject {
    return { typeUrl: distibutionTypes.withdrawValidatorCommission[0], value: distibutionTypes.withdrawValidatorCommission[1].fromPartial( data ) }
  }
}
